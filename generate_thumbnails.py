...
cases = {	
			...
			'chalmers2025the':(0,((0.23,0.72),(0.1,0.1))),
			...
			'rhee2023real':(0,((0.325,0.45),(0.3,0.3))),
			'chalmers2023real':(0,((0.36,0.7),(0.1,0.1))),
			'zaman2023mrmac':(0,((0.2,0.4),(0.2,0.2))),
			...
			'chalmers2022illumination':(1,((0.08,0.14),(0.38,0.38))),
			'chen2022casual':(1,((0.05,0.05),(0.17,0.25))),
			'weir2022deep':(1,((0.15,0.345),(0.2,0.2))),
			'weir2024full':(1,((0.14,0.3),(0.29,0.23))),
			'rhee2022teleport':(0,((0.34,0.61),(0.15,0.15))),
			'zhao2021adaptive':(0,((0.175,0.16),(0.11,0.11))),
			'suppan2021neural':(1,((0.11,0.7),(0.18,0.18))),
			'chalmers2020reconstructing':(1,((0.08,0.8),(0.12,0.12))),
			'chalmers2020illumination':(0,((0.3,0.05),(0.28,0.9))),
			'thompson2019real':(0,((0.18,0.6),(0.2,0.2))),
			'thompson2019underwater':(1,((0.07,0.13),(0.27,0.27))),
			'thompson2019real-caustics':(0,((0.25,0.7),(0.2,0.2))),
			'chalmers2018illumination':(32,((0.43,0.2),(0.52,0.52))),
			'petikam2021art':(0,((0.26,0.11),(0.25,0.25))),
			'welsford2021spectator':(0,((0.34,0.2),(0.25,0.25))),
			'welsford2020asymmetric':(1,((0.23,0.16),(0.1,0.1))),
			'rhee2020augmented':(2,((0.08,0.12),(0.25,0.25))),
			'chalmers2020shadow':(2,((0.33,0.08),(0.1,0.1))),
			'chalmers2020illumination':(3,((0.38,0.14),(0.17,0.17))),
			'petikam2018visual':(6,((0.07,0.16),(0.1,0.1))),
			'rhee2018mixed':(0,((0.3,0.15),(0.27,0.27))),
			'rhee2018mr360':(0,((0.3,0.73),(0.14,0.14))),
			'dean2018magic':(3,((0.65,0.12),(0.18,0.18))),
			'rhee2017mr360':(0,((0.13,0.26),(0.2,0.2))),
			'dodgson2017designing':(3,((0.1,0.5),(0.35,0.4))),
			'ma2015synthesising':(5,((0.55,0.7),(0.15,0.15))),
			'chalmers2014perceptually':(0,((0.29,0.7),(0.1,0.1))),
			'chalmers2014sky':(0,((0.48,0.215),(0.125,0.125))),
			'chalmers2013perceptually':(4,((0.53,0.57),(0.25,0.25)))
		}
